from ..database.common.db_tiendas import Db_tiendas
from ..database.common.db_productos import Db_productos
...
class Manager(Db_tiendas,Db_productos):
    ...
    lista con un objeto (Tienda o Producto) con los campos por defecto 'nulo'.
